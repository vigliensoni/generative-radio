...
class default_1 {
    constructor(piece) {
        ...
        this.elementPlayers = [];
        this.onended = () => { };
        this.fade = new helpers_1.Fade(globals_1.state.context, this.gain, this.piece.fade);
    }
    async play() {
    ...
    async stop(timestamp) {
        ...
        await (0, delay_1.default)((0, helpers_1.sec2ms)(this.piece.duration + this.piece.fade));
